            ...
            <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-none lg:p-0">
              <div className="aspect-w-10 aspect-h-6 sm:aspect-w-2 sm:aspect-h-1 lg:aspect-w-1">
                <img
                  ...
                  src="https://user-images.githubusercontent.com/112070747/202692811-45c0e59c-7436-43f7-a7e8-e17650976b74.png"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="relative bg-indigo-600 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
            ...
            <div className="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
              ...
              <p className="text-lg text-white">
                We create a digital badge for every contributor of Guance Cloud.
              </p>
              <a
